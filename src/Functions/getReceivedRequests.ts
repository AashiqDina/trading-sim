...
export default async function getReceivedRequests(props: any){
 try{
        const result = await axios.get(`https://tradingsim-backend.onrender.com/api/User/Get-Received-Request/${props.userId}`)
        console.log(result)
