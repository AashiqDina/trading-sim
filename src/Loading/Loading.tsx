...
export default function Loading(props: any){
    ...
    return (
        <>
            <div aria-label='Loading Content' style={{ transform: `scale(${props.scale || 1})`, marginBottom: `${props.marginBottom || 0.7}rem` }} role="status" aria-live="polite" className='BarContainer'>
